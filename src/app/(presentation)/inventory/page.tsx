...
//   // Define direct select filters that don't need transformation
...
//   // Define numeric select filters that need to be converted to numbers
...
//       }
//     } else if (directSelectFilters.includes(key)) {
//       // Direct mapping for enum-based select filters
//       acc[key] = value;
//     } else if (numericSelectFilters.includes(key)) {
...
const ClassifiedFilterSchema = z.object({
  ...
  fuelType: z.string().optional(),
  colour: z.string().optional(),
  bodyType: z.string().optional(), // Make sure bodyType is included
  doors: z.string().optional(),
  seats: z.string().optional(),
  ulezCompliance: z.string().optional(),
  color: z.string().optional(), // Add this for backward compatibility
});
...
const buildClassifiedFilterQuery = (
  ...
  // Define field mappings for query parameters that don't match database fields
  const fieldMappings: Record<string, string> = {
    color: "colour", // Map 'color' query param to 'colour' database field
  };
