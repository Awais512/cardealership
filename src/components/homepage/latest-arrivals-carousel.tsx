...
import { ClassifiedCard } from "@/app/(presentation)/inventory/_components/classified-card";
import { ClassifiedCardSkeleton } from "@/app/(presentation)/inventory/_components/classified-card-skeleton";
